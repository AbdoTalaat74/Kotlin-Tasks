...
fun main() {
    check(
        name = "valid IP addresses should return true",
...
//    "-1.168.1.1"      // Negative number
    check(
        name = "IP addresses with segments outside valid range should return false",
...
//    "001.002.003.004" // Leading zeros in all segments
    check(
        name = "IP addresses with leading zeros should return false",
...
//    "192.168.1.0"
    check(
        name = "Single zero segments should return true",
...
//    ""
    check(
        name = "IP addresses with wrong number of segments should return false",
...
//    "192.168.1.#"
    check(
        name = "IP addresses with non-numeric characters should return false",
        result = isValidIPv4("192.168.1"),
        correctResult = false
    )
...
//    ".192.168.1"      // Empty segment at beginning
    check(
        name = "IP addresses with empty segments should return false",
        result = isValidIPv4("192.168.1"),
        correctResult = false
    )
